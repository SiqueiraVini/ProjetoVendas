...
<body>
		...
		<div class="container-fluid">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="/colecionavel/lista">Colecionável</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/jogo/lista">Jogos</a></li>
			</ul>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor:
			...
			${qtdeProduto}</span> <span class="badge rounded-pill bg-success">Colecionável:
			${qtdeColecionavel}</span> <span class="badge rounded-pill bg-danger">Jogo:
			${qtdeJogo}</span>
